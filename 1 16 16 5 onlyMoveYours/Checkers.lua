...
if (pieces[index].row and pieces[index].row==row and pieces[index].column == column) then
return index;
end
...
--check legal diagonal move for non-king
...
--check legal diagonal move for king
if (king == true)
then
if (r2 == r1 + 1 and (c2 == c1 + 1 or c2 == c1 - 1))
	or
...
if (isValidMove(pieces[i].row,pieces[i].column,landedRow,landedColumn,
