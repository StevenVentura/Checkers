...
then
setStatusText("One of your men died!");
end
...
otherPlayer = command;
targetName = command;
print("otherplayer is " .. otherPlayer);
...
setStatusText("A piece has been kinged!");
...
setStatusText("It is their turn.");
return false
end;
...
setStatusText("You must take a piece.",8);
...
if (isValid == true)
		...
		local endMyTurn = 1;
		if (thereAreValidTakesForPiece(i) == true)
		then
