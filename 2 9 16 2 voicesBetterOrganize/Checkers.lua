...
local VOICE_WRONG_TURN = 1;
local VOICE_INVALID_MOVE = 2;
local VOICE_FRIENDLY_PIECE_TAKEN = 3;
local VOICE_ENEMY_PIECE_TAKEN = 4;
local VOICE_FRIENDLY_PIECE_KINGED = 5;--train noises!!!
local VOICE_ENEMY_PIECE_KINGED = 6;
local VOICE_WE_WON = 7;
local VOICE_THEY_WON = 8;
local VOICE_GAME_STARTED_ALLIANCE = 9;
local VOICE_GAME_STARTED_HORDE = 10;
local VOICE_OUT_OF_RANGE = 11;

local pieces = {};--holds the data for each checker
local voices = {};--holds the sound files for our team
...
local voices = isHostingTheCheckersGame and {
VOICE_INVALID_MOVE = {
1="Sound\\Character\\NightElf\\NightElfMaleErrorMessages\\NightElfMale_err_abilitycooldown02.ogg",
2="Sound\\Character\\NightElf\\NightElfMaleErrorMessages\\NightElfMale_err_ammoonly02.wav",
3=,
4=,
5=,
},
