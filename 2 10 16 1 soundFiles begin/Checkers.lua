...
local VOICE_FRIENDLY_PIECE_KINGED = "VOICE_FRIENDLY_PIECE_KINGED";--train noises!!!
...
local VOICE_GAME_STARTED = "VOICE_GAME_STARTED_ALLIANCE";
...
local placeHolder = "Sound\\Character\\Gnome\\GnomeFemaleChooChoo01.ogg";
...
VOICE_INVALID_MOVE = {
"Sound\\Character\\BloodElf\\BloodElfFemaleCheer01.ogg"
},
VOICE_FRIENDLY_PIECE_TAKEN = {
"Sound/character/BloodElf/BloodElfMaleRoar01.ogg",
"Sound/character/Orc/OrcVocalMale/VO_PCOrcMaleRoar01.ogg",
...
print("pls v");
print(checkersVoices["VOICE_OUT_OF_RANGE"]);
