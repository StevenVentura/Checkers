...
print("hostdead = " .. hostDeadCount .. "guestdead = " .. guestDeadCount);
...
if (not CheckersOptions or CheckersOptions["Sound"] == nil) then
--constructor
print("instantiating CheckersOptions");
CheckersOptions = {["Sound"] = true};
end--end constructor

--make the buttons!
local option_sound = CreateFrame("CheckButton",
		"option_sound",backgroundFrame,"OptionsCheckButtonTemplate");
