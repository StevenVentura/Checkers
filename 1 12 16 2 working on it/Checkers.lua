...
end--end function setCheckersMode

function putConfirmationBox()
...
popframe:Show();
end-- end function putConfirmationBox
...
print("|cff8888ff[Checkers] |cffff6666" .. sentCheckersRequestTo .. " does not have the Checkers addon. |cffddddddTell them to download it from |cffffff00www.curse.com/addons/wow/Checkers |cff8888ffso they can play with you!")
doTheyAlsoHaveTheAddon = -555;
end--end they dont :-(
...
print("|cff8888ff[Checkers] Game over. Score was " .. leftScore .. "-" .. rightScore);
setCheckersMode(MODE_WAITING_FOR_REQUESTS);
end--end function leaveTheGame
...
setCheckersMode(MODE_INITIALIZING_PONG);
initializeCheckers();
end
